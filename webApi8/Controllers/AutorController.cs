...
namespace webApi8.Controllers
{
    ...
    public class AutorController : ControllerBase
    {
        ...
        [HttpGet("BuscarAutorPorIdLivroq{idLivro}")]
        ...
        [HttpPut("EditarAutor")]
        public async Task<ActionResult<ResponseModel<List<AutorModel>>>> EditarAutor(AutorEdcaoDto autorEdcaoDto)
        {
            var autores = await _autorInterface.EditarAutor(autorEdcaoDto);
                return Ok(autores);
        }
    }
}
